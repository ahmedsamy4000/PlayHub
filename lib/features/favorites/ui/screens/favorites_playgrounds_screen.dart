...
class FavoritesPlaygroundsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<AppCubit, AppStates>(
      builder: (context, state) => state is GetFavoritesPlaygroundsLoadingState ? const CircularProgressIndicator() : Scaffold(
          appBar: AppBar(
                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(onPressed: (){
                        cubit.deletePlaygroundFromFavorites(playground['Id']);
